...
def makeHistogram():
    ...
    ofs = oechem.oemolostream("randDbFailedMols.smi") #keeps track of failed molecules
    ...
    plt.hist(histogram, color="red", density=False, bins=40)
    plt.ylabel("# of Molecules", fontsize=16)
    plt.xlabel("Atom Count", fontsize=16)
    plt.title("Randomly Selected Molecules: N-N Bonds", fontsize=20)
    plt.show()
